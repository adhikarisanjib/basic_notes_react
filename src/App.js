...
import NoteUpdate from './components/note/NoteUpdate';
      ...
      <div className='app'>
        ...
        <div className='main'>
          <Routes>
            ...
            <Route path='/noteCreate' element={<NoteCreate displayMessage={displayMessage} />}></Route>
            <Route path='/noteUpdate/:id' element={<NoteUpdate displayMessage={displayMessage} />}></Route>
            <Route path='/noteDelete/:id' element={<NoteDelete displayMessage={displayMessage} />}></Route>
